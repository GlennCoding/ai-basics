...
knowledge0 = And(
    Biconditional(AKnight, Not(AKnave)),  # If A is a knight they cannot be a knave
    Biconditional(
...
knowledge3 = And(
    ...
    Biconditional(AStatementKnight, Not(AStatementKnave)),
    # A's statement is truthful iff A is a knight
    Biconditional(
        AKnight,
        Or(
            And(AStatementKnight, AKnight),
            And(AStatementKnave, AKnave),
        ),
    ),
    # B says: "A said 'I am a knave'." AND "C is a knave."
    Biconditional(BKnight, And(AStatementKnave, CKnave)),
    # C says: "A is a knight."
...
# C says: D is a knave or I am a knave.
...
knowledge4 = And(
    ...
    Biconditional(BKnight, Not(BKnave)),
    Biconditional(CKnight, Not(CKnave)),
    Biconditional(DKnight, Not(DKnave)),
    # A says: C is my type.
    Biconditional(AKnight, Or(And(AKnight, CKnight), And(AKnave, CKnave))),
    # B says: "A is lying" and "C tells the truth."
    Biconditional(BKnight, And(AKnave, CKnight)),
    # C says: "D is a knave or I am a knave."
    Biconditional(CKnight, Or(DKnave, CKnave)),
)

# *********************************************
# Puzzle 5
# A says: B is truthful.
...
knowledge5 = And(
    ...
    # A says: C always tells the truth.
    # A says: B is my type.
    Biconditional(AKnight, And(BKnight, CKnight, Biconditional(AKnight, BKnight))),
)
